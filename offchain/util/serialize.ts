...
export function serializeCandidate(input: {
  ...
  return {
    ...
    morpho: candidate.morpho
      ? {
          uniqueKey: candidate.morpho.uniqueKey,
          borrowShares: candidate.morpho.borrowShares.toString(),
          marketParams: {
            ...
            lltv: candidate.morpho.marketParams.lltv.toString(),
          },
        }
      : undefined,
  };
...
export function serializePlan(plan: SimPlan): PlanSnapshot {
  return {
    ...
    morpho: plan.morpho
      ? {
          repayShares: plan.morpho.repayShares.toString(),
          callbackData: plan.morpho.callbackData,
          market: {
            loanToken: plan.morpho.market.loanToken,
            collateralToken: plan.morpho.market.collateralToken,
            oracle: plan.morpho.market.oracle,
            irm: plan.morpho.market.irm,
            lltv: plan.morpho.market.lltv.toString(),
          },
        }
      : undefined,
  };
